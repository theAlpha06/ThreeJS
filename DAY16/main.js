...
window.addEventListener('click', function (e) {
    ...
    sphereBodyArray.push(sphereBody);
...
function animate() {
    ...
    for (let i = 0; i < sphereBodyArray.length; i++) {
        sphereMeshArray[i].position.copy(sphereBodyArray[i].position);
        sphereMeshArray[i].quaternion.copy(sphereBodyArray[i].quaternion);
    }
